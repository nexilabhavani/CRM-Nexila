...
export const Categorys = [
  { value: "Select", label: "Select" },
  { value: "Graaduate - Seeking for Job", label: "Graaduate - Seeking for Job" },
  { value: "Work Exp-Non-Technical", label: "Work Exp-Non-Technical" },
  { value: "Work Exp-Technical", label: "Work Exp-Technical" },
  { value: "College - (Final Year)", label: "College - (Final Year)" },
  { value: "College - (1st-Pre Final Year)", label: "College - (1st-Pre Final Year)" },
];
...
export const Source = [
  ...
  export const Industry = [
    ...
    { value: 'Infomatica', label: 'Infomatica' },
